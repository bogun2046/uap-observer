...
def g8_12(
    ...
    empty_missing_world = _seed_claim_world(admin, f"{tag}-12-empty-keys", claims=_claims_result())
...
def _g8_13_bundle_tamper(
    ...
    for name in tampers:
        ...
        payload = _payload_for(admin, world["job_id"])
        attempt_id, token = grant_running_lease(admin, world["job_id"], f"wp8-3-13b-{name}-{tag}")
...
def _g8_13_at_least_once(
    ...
    try:
        ...
        require("g8-13 reclaim succeeded", reclaim_status in {"succeeded", "success"}, True)
