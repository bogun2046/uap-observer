...
def main() -> None:
    ...
    try:
        ...
        html_payload = (
            (FIXTURE_DIR / "sample.html")
            .read_bytes()
            .replace(b'content="2026-08-19T10:00:00Z"', b'content="not-a-date"')
        )
        fixtures = (
            (
                "html",
        ...
        with administrator.cursor() as cursor:
            ...
            cursor.execute("SELECT count(*) FROM core.extractions WHERE outcome = 'succeeded'")
