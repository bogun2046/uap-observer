...
def evaluate(platform: Path) -> list[Check]:
    ...
    return [
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0018_authorized_entity_merge"' in wp3_probe
        ...
        check(
            ...
            and "read_verified_object" in probe3
            and 'CURRENT_HEAD = "0018_authorized_entity_merge"' in probe3
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0018_authorized_entity_merge"' in probe4
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0018_authorized_entity_merge"' in probe5
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0018_authorized_entity_merge"' in probe6
            and 'CURRENT_HEAD = "0018_authorized_entity_merge"' in probe1
