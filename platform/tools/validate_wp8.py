...
def evaluate(platform: Path) -> list[Check]:
    ...
    return [
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0019_manual_claims_binding"' in wp3_probe
        ...
        check(
            ...
            and "read_verified_object" in probe3
            and 'CURRENT_HEAD = "0019_manual_claims_binding"' in probe3
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0019_manual_claims_binding"' in probe4
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0019_manual_claims_binding"' in probe5
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0019_manual_claims_binding"' in probe6
            and 'CURRENT_HEAD = "0019_manual_claims_binding"' in probe1
