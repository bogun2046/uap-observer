...
def evaluate(platform: Path) -> list[Check]:
    ...
    return [
        ...
        check(
            "unique_wp8_5_head",
            WP8_HEAD in revision_ids
            and revision_ids[revision_ids.index(WP8_HEAD) + 1] == WP8_PARENT
            and len(heads) == 1,
            {"heads": heads, "wp8": WP8_HEAD, "parent": WP8_PARENT},
            {"linear": True, "wp8": WP8_HEAD, "parent": WP8_PARENT},
        ),
        check(
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0014_review_session_authority"' in wp3_probe
        ...
        check(
            ...
            and "read_verified_object" in probe3
            and 'CURRENT_HEAD = "0014_review_session_authority"' in probe3
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0014_review_session_authority"' in probe4
        ...
        check(
            ...
            and "def _ungranted_advisory_locks" in probe5
            and "FROM pg_stat_activity" in probe5
            and "FROM pg_locks" in probe5
            and "set_config('application_name'" in probe5
            and "SET application_name = %s" not in probe5
            and "g8-18 waiter not SET syntax error" in probe5
            ...
            and 'CURRENT_HEAD = "0014_review_session_authority"' in probe5
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0014_review_session_authority"' in probe6
            and 'CURRENT_HEAD = "0014_review_session_authority"' in probe1
