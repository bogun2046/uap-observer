...
def evaluate(platform: Path) -> list[Check]:
    ...
    return [
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0017_selection_and_promotion"' in wp3_probe
        ...
        check(
            ...
            and "read_verified_object" in probe3
            and 'CURRENT_HEAD = "0017_selection_and_promotion"' in probe3
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0017_selection_and_promotion"' in probe4
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0017_selection_and_promotion"' in probe5
        ...
        check(
            ...
            and 'CURRENT_HEAD = "0017_selection_and_promotion"' in probe6
            and 'CURRENT_HEAD = "0017_selection_and_promotion"' in probe1
