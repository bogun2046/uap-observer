...
def g8_02(
    ...
    insert_extraction(admin, document_version_id, f"{tag}-g802", input_hash, text=f"g802-{tag}")
...
def g8_03(
    ...
    insert_extraction(admin, document_version_id, f"{tag}-g803", input_hash, text=f"g803-{tag}")
...
def g8_04(
    ...
    insert_extraction(admin, document_version_id, f"{tag}-g804", input_hash, text=f"g804-{tag}")
    execute(
        admin,
...
def g8_05(
    ...
    insert_extraction(admin, document_version_id, f"{tag}-g805", input_hash, text=f"g805-{tag}")
    run_id = insert_model_run(
        admin,
        document_version_id=document_version_id,
        task_type="claim_extraction",
...
def g8_06(
    ...
    insert_extraction(admin, document_version_id, f"{tag}-g806", input_hash, text=f"g806-{tag}")
    claim_run = insert_model_run(
        admin,
        document_version_id=document_version_id,
        task_type="claim_extraction",
