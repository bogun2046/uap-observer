...
def test_frozen_reason_codes_are_complete() -> None:
    ...
    assert KNOWLEDGE_LOCATOR_HASH_CONFLICT in FROZEN_REASON_CODES
    assert KNOWLEDGE_RELATION_TASK_NOT_IN_WP8 in FROZEN_REASON_CODES
    assert len(FROZEN_REASON_CODES) == 21
