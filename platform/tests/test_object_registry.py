...
def test_register_object_returns_new_and_reused_rows(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    created_connection = FakeConnection((candidate, "raw", physical.object_key, 3, "text/plain"))
    reused_connection = FakeConnection((uuid.uuid4(), "raw", physical.object_key, 3, "text/plain"))
