...
def test_wp8_5_merge_state_machine_present() -> None:
    ...
    assert 'CURRENT_HEAD = "0014_review_session_authority"' in probe5
...
def test_wp8_6_relation_reject_present() -> None:
    ...
    assert 'CURRENT_HEAD = "0014_review_session_authority"' in probe6
    ...
    assert 'CURRENT_HEAD = "0014_review_session_authority"' in probe1
