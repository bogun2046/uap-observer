...
def test_wp8_5_merge_state_machine_present() -> None:
    ...
    assert 'CURRENT_HEAD = "0015_review_case_lifecycle"' in probe5
...
def test_wp8_6_relation_reject_present() -> None:
    ...
    assert 'CURRENT_HEAD = "0015_review_case_lifecycle"' in probe6
    ...
    assert 'CURRENT_HEAD = "0015_review_case_lifecycle"' in probe1
