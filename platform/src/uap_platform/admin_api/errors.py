...
STATUS_BY_CODE: Final[dict[str, int]] = {
    ...
    "editorial_revision_not_found": 404,
    "editorial_revision_restore_request_invalid": 422,
    "editorial_revision_restore_reason_too_long": 422,
    ...
    "editorial_ai_item_not_found": 422,
    "editorial_evidence_request_invalid": 422,
    "editorial_evidence_not_found": 422,
    "editorial_evidence_version_mismatch": 422,
    "editorial_evidence_extraction_mismatch": 422,
    "editorial_evidence_provenance_mismatch": 422,
    "editorial_evidence_malformed_uuid": 422,
    "editorial_evidence_association_removed": 200,
...
SAFE_DETAIL: Final[dict[str, str | None]] = {
    ...
    "editorial_revision_not_found": "Editorial revision not found.",
    "editorial_revision_restore_request_invalid": "Editorial revision restore request is invalid.",
    "editorial_revision_restore_reason_too_long": "Editorial revision restore reason is too long.",
    ...
    "editorial_ai_item_not_found": "The editorial item was not found in the expected revision.",
    "editorial_evidence_request_invalid": "Evidence association is invalid.",
    "editorial_evidence_not_found": "Evidence span was not found.",
    "editorial_evidence_version_mismatch": "Evidence span belongs to another document version.",
    "editorial_evidence_extraction_mismatch": (
        "Evidence span is not tied to the document extraction."
    ),
    "editorial_evidence_provenance_mismatch": "Evidence provenance does not match the source.",
    "editorial_evidence_malformed_uuid": "Evidence span identifier is malformed.",
