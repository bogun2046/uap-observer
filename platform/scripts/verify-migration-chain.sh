...
alembic_step -x role=migrator upgrade head
test "$(query "SELECT version_num FROM public.alembic_version")" = "0006_collectors"
...
echo "Migration chain verified: 0001 -> 0002 -> 0003 -> 0004 -> 0005 -> 0006, idempotent head, downgrade smoke."
