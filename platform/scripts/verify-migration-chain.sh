...
alembic_step -x role=migrator upgrade head
test "$(query "SELECT version_num FROM public.alembic_version")" = "0005_durable_jobs"
...
echo "Migration chain verified: 0001 -> 0002 -> 0003 -> 0004 -> 0005, idempotent head, downgrade smoke."
