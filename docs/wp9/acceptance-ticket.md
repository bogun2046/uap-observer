...
| `G9-GATE-9.2` | WP9.2 | G9-06–G9-09、G9-31 | grant、selection、merge 包装 | 可授权 WP9.3 |
| `G9-GATE-9.3` | WP9.3 | G9-10–G9-16、G9-27–G9-30 | candidate 晋升、merge 包装、手工 Claim | 可授权 WP9.4 |
...
| `G9-GATE-9.6` | WP9.6 | G9-23–G9-26、G9-32–G9-33 及全量复跑 | 公开投影 | 可签署 G9 |
...
4. revise 后同一 subject 至多一行 `grant_status='active'`；superseded 行 `withdrawn_at IS NULL`。
